                ...
                <a href='/' id='btnClose'>
                    ...
                    <div className='episode__infomartions'>
                        <div className='episode__container-img'>
                            <img src={episode3['cover']} alt='Caixa de som com assistente virtual, alexa, google assistente, siri' />
                        </div>
                    ...
                    <div className='player'>
                        <audio ref={audioPlayer} src={episode3['audio']}/>
