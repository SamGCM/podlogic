                ...
                <a href='/' id='btnClose'>
                    ...
                    <div className='episode__infomartions'>
                        <div className='episode__container-img'>
                            <img src={episode2['cover']} alt='Homem em frente a notebook, trabalhando home office, em casa' />
                        </div>
                        
                        <div ref={episodeContainerText} className='episode__container-text' >
                            <h1>Episódio {episode2['episodeNumber']} - {episode2['name']}</h1>
                            <p ref={text}>  {episode2['description']}</p>
                    ...
                    <div className='player'>
                        <audio ref={audioPlayer} src={episode2['audio']}/>
